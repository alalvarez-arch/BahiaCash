...
- El botón **Escanear** abre la cámara (o galería).
- Puedes fotografiar **varios tickets a la vez**; la app detecta todos los importes (formato `12,50` / `12.50`) y te deja marcar/desmarcar antes de añadirlos.
- La **primera vez** necesita internet para descargar el motor OCR (Tesseract). Después puede reutilizarlo en la misma sesión.
- Consejos: buena luz, foto nítida, importes legibles, no demasiado lejos.
